import{_ as a,c as l,a as s,b as p,t as o,d as e,o as c}from"./app.c378b30a.js";const B=JSON.parse('{"title":".vehicles","description":"","frontmatter":{"title":".vehicles","order":-99},"headers":[],"relativePath":"api-client/data/vehicles.md","lastUpdated":1675454311000}'),t={name:"api-client/data/vehicles.md"},r={id:"frontmatter-title",tabindex:"-1"},y=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),F=e(`<p>Simply returns a list of all vehicle information. Includes the following interface for each vehicle.</p><h2 id="vehicleinfo" tabindex="-1">VehicleInfo <a class="header-anchor" href="#vehicleinfo" aria-hidden="true">#</a></h2><div class="language-ts"><button class="copy"></button><span class="lang">ts</span><pre><code><span class="line"><span style="color:#676E95;">/**</span></span>
